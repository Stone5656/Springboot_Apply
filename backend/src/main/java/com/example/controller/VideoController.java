...
public class VideoController {
    ...
    public ResponseEntity<VideoResponseDTO> getVideo(
            @Parameter(description = "動画ID") @PathVariable Long id
        ) {
    ...
    public ResponseEntity<Page<VideoResponseDTO>> getMyVideos(
        ...
        Page<VideoResponseDTO> myVideos = videoService.getMyVideos(user.getId(), pageable);
    ...
    public ResponseEntity<Page<PublicVideoResponseDTO>> searchPublicVideos(
            ...
            @ModelAttribute SearchRequestDTO searchRequest,
    ...
    public ResponseEntity<VideoResponseDTO> createVideo(
        ...
        VideoResponseDTO created = videoService.createVideo(request, user);
