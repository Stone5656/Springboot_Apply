 ...
 */
@Tag(name = "Categories", description = "カテゴリ関連API")
@RestController
@RequestMapping("/api")
...
public class CategoryController {
    ...
    public ResponseEntity<Void> addCategoriesToVideo(@PathVariable UUID videoId,
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<Void> replaceVideoCategory(@PathVariable UUID videoId,
            @RequestBody List<UUID> categoryIds) {
        categoryService.replaceVideoCategory(videoId, categoryIds);
        return ResponseEntity.noContent().build();
    }
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<Void> removeCategoryFromVideo(@PathVariable UUID videoId,
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<Void> addCategoriesToLiveStream(@PathVariable UUID liveStreamId,
            @RequestBody List<UUID> categoryIds) {
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<Void> replaceLiveStreamCategory(@PathVariable UUID liveStreamId,
            @RequestBody List<UUID> categoryIds) {
        categoryService.replaceLiveStreamCategory(liveStreamId, categoryIds);
        return ResponseEntity.noContent().build();
    }
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<Void> removeCategoryFromLiveStream(@PathVariable UUID liveStreamId,
            @PathVariable UUID categoryId) {
